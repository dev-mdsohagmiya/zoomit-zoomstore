  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          href="/admin/users"
          className="rounded-lg border border-purple-200 bg-white p-6 hover:shadow-lg transition-shadow"
        >
          <h2 className="font-semibold text-purple-900">Users</h2>
        ...
        <Link
          ...
          className="rounded-lg border border-purple-200 bg-white p-6 hover:shadow-lg transition-shadow"
        >
          <h2 className="font-semibold text-purple-900">Products</h2>
          <p className="text-sm text-purple-700">
        ...
        <Link
          ...
          className="rounded-lg border border-purple-200 bg-white p-6 hover:shadow-lg transition-shadow"
        >
          <h2 className="font-semibold text-purple-900">Orders</h2>
          <p className="text-sm text-purple-700">
